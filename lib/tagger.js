  ...
  if (section === 'reacoes') {
    ...
    for (const s of sentences) {
      ...
      if (text.includes('anafil') || text.includes('alérg') || text.includes('hipersens')) {
        groups['side_effects_hypersensitivity'].texts.push(s.text);
        ...
        groups['side_effects_dermatologic'].texts.push(s.text);
        ...
        groups['side_effects_hematologic'].texts.push(s.text);
      } else if (text.includes('pressão') || text.includes('cardíac') || text.includes('bronco')) {
        groups['side_effects_cardiovascular'].texts.push(s.text);
      } else {
        groups['side_effects_other'].texts.push(s.text);
      }
    }
