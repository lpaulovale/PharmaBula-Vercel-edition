...
to the retrieved documents?
   - Score 10 if: All drug-specific facts (doses, effects, contraindications, frequencies) \
are in the documents.
   - Score 10 if: Generic disclaimers like "consulte um médico" or "a bula pode não \
mencionar todos os efeitos" — these are NOT drug claims.
   - Score 10 if: Meta-statements like "Conforme a bula" or "A bula menciona" when \
the information IS actually in the bula.
   - Score 5-7 if: Some minor claims lack documentation but core info is grounded.
   - Score 0-4 if: Specific drug facts (doses, effects, interactions) are invented \
or contradict the documents.
