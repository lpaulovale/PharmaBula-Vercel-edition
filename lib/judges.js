...
ao fígado")
   - IMPORTANT: If a term is explained immediately after (e.g. "reações \
alérgicas (erupção cutânea, urticária)"), this COUNTS as explained.
...
Response SHOULD have parallel structure.
   ...
   - IMPORTANT: Before penalizing, VERIFY that the response actually \
has the formatting you're criticizing. Don't claim "3 headers and bullet \
points" if the response is plain prose with no headers.
...
contextual justification?
   - IMPORTANT: Before claiming "starts with bullet points", VERIFY \
that the response actually HAS bullet points. Don't hallucinate structure.
