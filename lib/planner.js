...
2. CRITICAL: If the user asks about ONE specific topic (like "efeitos colaterais", "posologia", "contraindicações"), use ONLY ONE get_section call for that specific section. DO NOT fetch multiple sections.
3. Only use get_bula_data if the user asks for a complete overview or multiple topics at once.
4. Minimize tool calls - use the minimum number of tools needed to answer the question.`;
