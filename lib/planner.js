...
IMPORTANT: Set needs_history=true ONLY if the question contains pronouns or references to previous context (e.g., "ele", "ela", "isso", "esse medicamento", "a dose anterior", "continuar tomando"). For standalone questions about a medication, set needs_history=false.`;
