...
const PDF_TIMEOUT_MS = 15000; // Longer timeout for PDF downloads
 ...
 * Uses pdfjs-dist for better text extraction with layout preservation.
 *
...
async function fetchBulaText(pdfUrl) {
  ...
  try {
    ...
    console.log(`[ANVISA] PDF loaded: ${pdf.numPages} pages`);
    ...
    for (let i = 1; i <= pdf.numPages; i++) {
      ...
      // Extract text items with better layout handling
    ...
    console.log(`[ANVISA] Extracted ${fullText.length} chars from PDF`);
