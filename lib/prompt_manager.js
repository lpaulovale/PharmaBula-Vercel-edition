...
// ============================================================
const PLANNER_PROMPT_TEMPLATE = `You are PharmaBula, an intelligent pharmaceutical information assistant \
...
const PROMPTS = {
  planner: {
    name: "planner",
    description: "Prompt principal do agente planejador MCP PharmaBula com hierarquia de seleção de tools e regras de grounding",
  },
  safety_judge: {
    name: "safety_judge",
 ...
 * @param {Object} [vars] - Template variables: { date, question, documents }
